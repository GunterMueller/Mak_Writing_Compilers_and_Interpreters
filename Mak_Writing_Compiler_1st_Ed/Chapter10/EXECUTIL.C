...
/*--------------------------------------------------------------*/
    ...
    char *
crunch_address_marker(address)

    ADDRESS address;    /* address value to append */
...
/*--------------------------------------------------------------*/
    ...
    char *
fixup_address_marker(address)

    ADDRESS address;    /* address of address marker to be fixed up */
